...
import com.example.pokemon.databinding.RegistroBinding  // Cambiado para usar el nombre correcto
import com.google.firebase.auth.FirebaseAuth
import com.google.firebase.firestore.FirebaseFirestore

class Registro : Fragment() {

    private var _binding: RegistroBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = RegistroBinding.inflate(inflater, container, false)
        return binding.root
    }
